#!/bin/bash
#SBATCH --job-name=v1.5_ft
#SBATCH --output=sbatch_output/%j_fine_tuning-v1.5.out
#SBATCH --error=sbatch_output/%j_fine_tuning_v1.5.err
...
SCRIPT_NAME="/leonardo/home/userexternal/ecassano/projects/SAeUron_finetuning/scripts/sae_finetuning_v1.5.py"
...
SAVE_DIR="/leonardo_work/IscrC_MAGNIFY/cassano/saeuron/sae_checkpoints/dual_concept_optimized/v1.5/ce_weight_3.0_sparsity_0.01"
