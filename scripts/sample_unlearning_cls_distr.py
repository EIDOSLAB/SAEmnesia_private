...
def main(
    ...
    start_from=18,  # NEW: index to start from
):
    ...
    # NEW: Skip already processed classes
    classes_to_process = class_available[start_from:]
    ...
    progress_bar = tqdm(
        ...
        initial=0,  # Start progress bar from 0 for remaining classes
    )
    for class_to_unlearn in progress_bar:
        ...
        # NEW: Check if this class was already completed
        if start_from > 0:
            # Check if output files exist for this class
